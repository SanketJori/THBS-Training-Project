...
<body>
	<p class="text-success text-center">${success_msg}</p>
	<p class="text-danger text-center">${error_msg}</p>
	<p class="text-danger text-center">${date_error}</p>
	<div class="container m-2 mx-auto bg-dark">
		...
		<form action="processTicket" method="post">
			<div class="m-auto p-4 " id="container">
				...
				<label class="text-light mb-2" for="from">From :</label> 
				<select
					class="form-select mb-2 border-dark" name="source_place"
					id="from" required>
				...
				<label class="text-light mb-2" for="to">To :</label> 
				<select
				...
				<label class="text-light mb-2" for="travel_date">Select
					travel date :</label> <input class="form-control mb-2 border-dark"
					type="date" name="travel_date" id="travel_date" value="select date"
					required> <label class="text-light mb-2"
					for="no_of_persons">Select no of persons :</label>
				<div class="row">
					<div class="col">
